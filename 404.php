	...
	<section class="inner-content cf">
		<section class="inner-block cf">
			<header class="archive-block-header home-block-header 404-title">
				<h1 title="404 Error" class="page-title"><?php _e( '404 Error', 'modern-real-estate' ); ?></h1>
			</header>

			<section class="blog-post 404-error no-posts">
				<section class="blog-post-content">
					<p><?php _e( 'We apologize but something when wrong while trying to find what you were looking for. Please use the navigation below to navigate to your destination.', 'modern-real-estate' ); ?></p>

					<section id="search-again" class="search-again search-block no-posts no-search-results">
						<p><?php _e( 'Search:', 'modern-real-estate' ); ?></p>
