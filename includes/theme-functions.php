...
function sds_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'content_color',
			array(
				'label'  => __( 'Content Color', 'modern-estate' ),
				'section' => 'colors',
...
function sds_widgets_init() {
	...
	// Secondary sidebar
	register_sidebar( array(
		'name'          => __( 'Secondary Sidebar', 'modern-estate' ),
		'id'            => 'secondary-sidebar',
		'description'   => __( 'This widget area is the secondary widget area.', 'modern-estate' ),
	...
	register_sidebar( array(
		...
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings > Reading in the Dashboard.* This widget area is displayed above the content on the Front Page.', 'modern-estate' ),
