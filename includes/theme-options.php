	...
	class SDS_Theme_Options {
		...
		function admin_init() {
			...
			if ( function_exists( 'sds_content_layouts' ) ) {
				add_settings_section( 'sds_theme_options_content_layout_section', __( 'Content Layout', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_section' ), 'sds-theme-options[content-layout]' );
				add_settings_field( 'sds_theme_options_content_layout_global_field', __( 'Global', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_global_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_front_page_field', __( 'Front Page', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_front_page_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_home_field', __( 'Home (Blog)', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_home_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_single_field', __( 'Single Post', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_single_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_page_field', __( 'Single Page', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_page_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_archive_field', __( 'Archive', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_archive_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_category_field', __( 'Category', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_category_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_tag_field', __( 'Tag', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_tag_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
				add_settings_field( 'sds_theme_options_content_layout_404_field', __( '404 Error', 'modern-estate'), array( $this, 'sds_theme_options_content_layout_404_field' ), 'sds-theme-options[content-layout]', 'sds_theme_options_content_layout_section' );
			}
		...
		?>
			...
			<input type="submit" id="sds_theme_options_logo_attach" class="button-primary sds-theme-options-upload" name="sds_theme_options_logo_attach"  value="<?php esc_attr_e( 'Choose Logo', 'modern-estate' ); ?>" data-media-title="Choose A Logo" data-media-button-text="Use As Logo" />
		...
		?>
			<div class="sds-theme-options-web-fonts-wrap">
				...
				<div class="sds-theme-options-web-font sds-theme-options-web-font-default">
					...
					<span class="sds-theme-options-web-font-label-default"><?php _e( 'Default', 'modern-estate' ); ?></span>
				</div>
		...
		?>
			<p><?php _e( 'Control the layout of the content on your site here. Choose a global layout scheme to be used across your entire site or specifiy individual content type layout schemes by adjusting the options below.', 'modern-estate' ); ?></p>
		<?php
		}
		...
		?>
			<div class="wrap about-wrap">
				...
				<h1><?php echo $this->theme->get( 'Name' ); ?> <?php _e( 'Theme Options', 'modern-estate' ); ?></h1>
				<div class="about-text sds-about-text"><?php printf( _x( '%1$s', 'Theme options panel description', 'modern-estate' ), self::$options_page_description ); ?></div>
				...
				<h3 class="nav-tab-wrapper sds-theme-options-nav-tab-wrapper sds-theme-options-tab-wrap">
					<a href="#general" id="general-tab" class="nav-tab sds-theme-options-tab nav-tab-active"><?php _e( 'General', 'modern-estate' ); ?></a>
					<?php if ( function_exists( 'sds_content_layouts' ) ) : ?>
						<a href="#content-layout" id="content-layout-tab" class="nav-tab sds-theme-options-tab"><?php _e( 'Layout', 'modern-estate' ); ?></a>
					<?php endif; ?>
					...
					<a href="#help-support" id="help-support-tab" class="nav-tab sds-theme-options-tab"><?php _e( 'Support', 'modern-estate' ); ?></a>
				</h3>
				...
				<form method="post" action="options.php" enctype="multipart/form-data" id="sds-theme-options-form">
					...
					<p class="submit">
						<?php submit_button( __( 'Save Options', 'modern-estate' ), 'primary', 'submit', false ); ?>
						<?php submit_button( __( 'Restore Defaults', 'modern-estate' ), 'secondary', 'sds_theme_options[reset]', false ); ?>
					</p>
				</form>
				...
				<div id="sds-theme-options-ads" class="sidebar">
					<div class="sds-theme-options-ad">
						...
						<div class="slocum-themes">
							<?php printf( __( '<a href="%1$s" target="_blank"><strong>How to setup the perfect WordPress website</strong></a>', 'modern-estate' ), 'http://slocumthemes.com/build-perfect-wordpress-website/' ); ?>
						</div>

						<br />

						<div class="slocum-themes">
							<?php printf( __( 'Brought to you by <a href="%1$s" target="_blank">Slocum Themes</a>', 'modern-estate' ), 'http://slocumthemes.com/' ); ?>
						</div>
					</div>
		...
		function content_layouts_field( $field_id, $description = false ) {
			...
			?>
				...
				<span class="description"><?php  printf( _x( '%1$s', 'Content layout description; describes where the content layout will be applied', 'modern-estate' ), $description ); ?></span>
		<?php
		}
	}
